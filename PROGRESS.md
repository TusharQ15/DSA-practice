...
| **Strings** | 10 | Two Pointers, Hashing, Frequency Counting, Sliding Window, Stack, Backtracking |
| **Total** | **25** | |
...
- [x] Generate Parentheses (Backtracking) - Medium
...
## Weekly Goals (Dec 23-29, 2025)

### Target Problems
- [ ] 3-4 Array problems (Sliding Window, Prefix Sum)
- [ ] 2-3 String problems (Two Pointers, Sliding Window)
